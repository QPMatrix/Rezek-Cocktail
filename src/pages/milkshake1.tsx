...
import { MileShake1 } from "@/constants/milkshake";
...
const Fakfakhena = () => {
  ...
  return (
    <main
      ...
      dir="rtl"
    >
      <h1 className="font-bold text-4xl text-center mb-8">فخفينا</h1>
      <section className="flex flex-col items-center w-full">
        {MileShake1.map((item, index) => (
          <div
            key={index}
